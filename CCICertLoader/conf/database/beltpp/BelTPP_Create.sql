...
--------------------------------------------------------
  ...
  CREATE TABLE "C_PRODUCT" ("PRODUCT_ID" NUMBER, "CERT_ID" NUMBER, "NUMERATOR" VARCHAR2(1000 BYTE), "TOVAR" VARCHAR2(4000 BYTE), "VIDUP" VARCHAR2(1000 BYTE), "KRITER" VARCHAR2(1000 BYTE), "VES" VARCHAR2(1000 BYTE), "SCHET" VARCHAR2(1000 BYTE), "FOBVALUE" VARCHAR2(200 BYTE)) ;
--------------------------------------------------------
